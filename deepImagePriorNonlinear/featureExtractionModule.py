...
def deepPriorCd(data1, data2, manualSeed, outputLayerNumbers):
    ...
    detectedChangeMapNormalized, timeVector1FeatureAggregated, timeVector2FeatureAggregated = detectChange(data1, data2, numberOfImageChannels, nFeaturesIntermediateLayers, modelInputMean, useCuda,
                                                                                                           outputLayerNumbers)
